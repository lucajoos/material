...
theme.loadSyntax = function ()
	...
	local syntax = {
		...
		Keyword                 = { fg = colors.purple, style = 'italic' }, -- italic for, do, while, etc.
		...
		Repeat                  = { fg = colors.purple, style = 'italic' }, -- italic any other keyword
...
theme.loadEditor = function ()
	...
	local editor = {
		...
		MsgArea = { fg = colors.white, bg = colors.bg_num },
...
theme.loadTreeSitter = function ()
	...
	local treesitter = {
		...
		TSComment= { fg = colors.comments, style = 'italic' }, -- For comment blocks.
		TSConstructor = { fg = colors.white }, -- For constructor calls and definitions: `= { }` in Lua, and Java constructors.
    ...
    TSError = { fg = colors.error }, -- For syntax/parser errors.
		...
		TSFuncBuiltin = { fg = colors.yellow, style = 'italic' }, -- For builtin functions: `table.insert` in Lua.
		...
		TSKeyword = { fg = colors.purple, style = 'italic' }, -- For keywords that don't fall in previous categories.
    ...
    --
    -- TypeScript
    typescriptImport = { fg = colors.white },
    typescriptImportType = { fg = colors.green, style = 'italic' },
    typescriptExport = { fg = colors.white },
    typescriptExportType = { fg = colors.green, style = 'italic' },
    typescriptModule = { fg = colors.white },
	  typescriptType = { fg = colors.green, style = 'italic' },
    typescriptArrowFunc = { fg = colors.cyan },
